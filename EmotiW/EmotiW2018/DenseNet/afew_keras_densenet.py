...
from keras.layers import Dense, Activation, Dropout, Reshape, Conv2D, Conv2DTranspose, UpSampling2D
from keras.layers import MaxPooling2D, AveragePooling2D, GlobalAveragePooling2D, GlobalMaxPooling2D, Input
from keras.layers import Concatenate, BatchNormalization, ZeroPadding2D
