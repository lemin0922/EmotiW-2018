...
print("Load data...")
#TODO : check dataset
X_TRAIN_PATH = TRAIN_PATH + 'x_DenseNet169_original_frames_no_overlap.npz'
Y_TRAIN_PATH = TRAIN_PATH + 'y_DenseNet169_original_frames_no_overlap.npz'
...
def RNN(x, weight, bias):
    ...
    dropout_cell = rnn.DropoutWrapper(cell, output_keep_prob=keep_prob)
    # cell = rnn.MultiRNNCell([dropout_cell] * num_layer)
