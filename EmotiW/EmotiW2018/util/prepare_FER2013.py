...
if __name__ == '__main__':
    # TODO : check path, filename and dataset
    DATA_ROOT = '/home/lemin/nas/DMSL/FER2013/Images/PrivateTest'
    SAVE_ROOT = '/home/lemin/nas/DMSL/FER2013/Images/NpzData'
    X_DATA = '/X_test_color.npz'
    Y_DATA = '/y_test_color.npz'
    ...
    paths_dict = defaultdict(object)
    label_dict = defaultdict(lambda : [])

    num = 0
    for key, value in LABEL.items():
        temp = list(list_all_files(DATA_ROOT + value, ['.jpg', '.png']))
        paths_dict[key] = temp
        num += len(temp)
        print('Loaded', len(temp),  key + ' file lists')
